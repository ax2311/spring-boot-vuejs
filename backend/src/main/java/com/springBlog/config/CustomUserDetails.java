...
public class CustomUserDetails implements UserDetails {
    ...
    public CustomUserDetails(User user) {
        ...
        this.authorities = translate(user.getUserRoles());
    }
     ...
     */
    private Collection<? extends GrantedAuthority> translate(List<UserRoles> userRoles) {
        List<GrantedAuthority> authorities = new ArrayList<>();
        for (UserRoles userole : userRoles) {
            String name = userole.getRole().getName().toUpperCase();
